...
RSpec.describe "/papers", type: :request do
  ...
  let(:invalid_attributes) {
    {title: 'This is invalid', fun_level: '5', year: 0000}
  }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      let(:new_attributes) {
        {title: 'COMPUTING MACHINERY AND INTELLIGENCE', venue: 'Mind 49: 433-460', year: 2021}
      }
    ...
    context "with invalid parameters" do
      it "renders an error response (i.e. to display the 'edit' template)" do
        paper = Paper.create! valid_attributes
